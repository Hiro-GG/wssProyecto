<%@ Page Title="" Language="C#" MasterPageFile="~/ADMINISTRADOR/mpAdministrador.Master" AutoEventWireup="true" CodeBehind="frmAdABCUsuario.aspx.cs" Inherits="wssProyecto.ADMINISTRADOR.Formulario_web14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="perfil-header">
         <asp:Label ID="lblMiPerfil" runat="server" Text="Mi Perfil" CssClass="titulo-principal"></asp:Label>
     </div>
     ...
     <div class="perfil-content">
         ...
         <div class="seccion">
             ...
             <div class="fila-campos">
                 <div class="grupo-campo">
                     ...
                     <asp:DropDownList ID="dwlRoles" runat="server"></asp:DropDownList>
                 </div>
                 <div class="grupo-campo">
         ...
         <div class="seccion">
             ...
             <div class="fila-campos">
                 <div class="grupo-campo largo">
                     ...
                     <asp:TextBox ID="txtUsuarioAcceso" runat="server" placeHolder="Tu nombre de usuario" CssClass="campo-texto"></asp:TextBox>
                 </div>
             </div>
             ...
             <div class="fila-campos">
                 <div class="grupo-campo">
                     ...
                     <asp:TextBox ID="txtContraseña" runat="server" placeHolder="Contraseña de acceso" CssClass="campo-texto"></asp:TextBox>
                 </div>
                 <div class="grupo-campo">
                     <asp:Label ID="lblConfiContra" runat="server" Text="Confirmar Contraseña" CssClass="etiqueta"></asp:Label>
                     <asp:TextBox ID="txtConfiContra" runat="server" placeHolder="Confirmar contraseña de acceso" CssClass="campo-texto"></asp:TextBox>
                 </div>
             </div>
         </div>
         ...
         <div class="seccion-botones">
             <asp:Button ID="btnModificar" runat="server" Text="Guardar Cambios" CssClass="boton-accion" OnClick="btnModificar_Click" CausesValidation="false" />

             <asp:Button ID="btnRegistrar" 
                runat="server" 
                Text="REGISTRAR" 
                CssClass="boton-accion" OnClick="btnRegistrar_Click" />

            <asp:Button ID="btnNuevoUsuario" 
                        runat="server" 
                        Text="NUEVO USUARIO" 
                        CssClass="boton-accion" OnClick="btnNuevoUsuario_Click" />

            <asp:Button ID="btnRegresar" 
                        runat="server" 
                        Text="REGRESAR" 
                        CssClass="boton-accion" OnClick="btnRegresar_Click" />
         </div>
     </div>
 </div>
</asp:Content>
