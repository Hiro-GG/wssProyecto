<%@ Page Title="" Language="C#" MasterPageFile="~/CLIENTE/mpCliente.Master" AutoEventWireup="true" CodeBehind="frmCliMisCompras.aspx.cs" Inherits="wssProyecto.CLIENTE.Formulario_web14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="compras-container">
        ...
        <div class="page-header">
            <asp:Label ID="lblConsultas" runat="server" Text="Mis Compras"></asp:Label>
